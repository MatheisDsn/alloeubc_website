...
class AnnonceForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "etat": forms.Select(attrs={"class": "mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-secondary-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"}),
            "taille": forms.TextInput(attrs={
                "class": "mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-secondary-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500", 
                "placeholder": "Ex: M, L, XL, 38, 40, 42...",
                "list": "tailles-suggestions"
            }),
